...
const Signin = () => {
  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 mt-8 mb-10">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <img className="mx-auto h-10 w-auto" src="https://via.placeholder.com/40x40.png?text=E" alt="Envosafe" />
        <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Sign in to your Envosafe account</h2>
      </div>
